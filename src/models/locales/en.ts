export const enTranslate = {
  ...
  enTopPageUrl: 'https://sites.google.com/vos.nagaokaut.ac.jp/tech-meeting',
  enMoreInfo: '... more info',
  enBMPageUrl: 'https://scrapbox.io/binaural-meet/Top_page',
  enBMMoreInfo: 'Binaural Meet',
  YourName: 'Enter your name',
  Venue: 'Venue',
  EnterTheVenue: 'Enter the venue',
  Contents: 'Contents',
  createAndShareTitle: '_Create and Share',
  ...
  shareSameRoom: 'Create RealRoom (_a)',
  shareSameRoomTip: 'Place the RealRoom. When inside the area, audio within the area will be blocked.',
  ...
  ttBeingRecorded: "Being recorded",
  ...
  emConnection: 'Please check internet connection. Tech meeting uses https. If internet is OK, the server may have problems.',
  ...
  emNoMic: 'Please check if your PC has a microphone. Tech meeting requires it.',
  emClose: 'Close',
  ...
  emNoChannel: 'Please check firewall setting. Tech meeting connect to https (port 443/TCP) and port 8801-8810/UDP or 80/TCP.',
  enterRoom: 'You do not have permission to enter this room.',
  eAdmin: 'you are not the admin of this room',
  eRoomInfo: 'Fail to download room information',

  etDataConnection: 'Data connection failed',
  etRtcConnection: 'Media connection failed',
  emDataConnection: 'Please check firewall setting. Tech meeting connect to https (port 443/TCP).',
  emRtcConnection: 'Please check firewall setting. Tech meeting connect to https (port 443/TCP).',
  ...
  cmGetHistory: 'Get chat history (100 messages)',
  ...
  failedToPlaybackSound: 'failed to play notification sound',
  ...
  adSynclimits: 'Sync limits',
  adLockAllContents: 'Lock all contents',
  adUnLockAllContents: 'UnLock all contents',
  adMuteAllVideos: 'Mute all videos',
  adShowAllVideos: 'Show all videos',
  adMuteAllMics: 'Mute all mics',
  adSwitchOnAllMics: 'Switch on all mics',
  adRemoveAllContents: 'Remove all Contents',
  adClearContentsByUserName: 'Clear contents by user name',
  adReload: 'Reload',
  adBackColor: 'Back color',
  adPatternColor:  'Pattern color',
  adDefault: 'Default',
}
