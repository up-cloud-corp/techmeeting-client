export const enTranslate = {
  ...
  shareSameRoom: 'Create same room (_a)',
  shareSameRoomTip: 'Place the same room. When inside the area, audio within the area will be blocked.',
