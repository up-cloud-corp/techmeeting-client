export const jaTranslate = {
  ...
  enMoreInfo: '詳細',
  enBMPageUrl: 'https://scrapbox.io/binaural-meet/%E3%83%88%E3%83%83%E3%83%97%E3%83%9A%E3%83%BC%E3%82%B8',
  ...
  shareSameRoom: 'リアルルーム (_a)',
  shareSameRoomTip: 'リアルルームを置きます。エリア内ではエリア内の音声が遮断されます。',
  ...
  emConnection: 'インターネット接続を確認してください。Tech meetingは https を使います。インターネット接続の問題でなければ、サーバの問題かもしれません。',
  etMicPermission: 'マイク利用不可',
  emMicPermission: 'ブラウザがマイクの利用を許可しませんでした。ブラウザのURLの左の鍵のアイコンから許可し、ブラウザをリロードしてください。',
  etNoMic: 'マイクがありません',
  emNoMic: 'Tech meetingにはマイクが必要です。パソコンにマイクがついていることを確認してください。',
  emClose: '閉じる',
  emResetRtc: 'RTCをリセット',
  ...
  emDataConnection: 'ファイアウォールの設定を確認してください。Tech meeting は https(443番)ポートに接続します。',
  emRtcConnection: 'ファイアウォールの設定を確認してください。Tech meeting は https(443番)ポートに接続します。',
...
//  emRetry: '接続が切れたので、再接続を試みています。インターネット接続を確認してください。',
  ...
  failedToPlaybackSound: '音声の再生に失敗しました。',
  stSettingTitle: '設定',
  stVideoLimit: '映像ストリーム数の上限',
  stAudioLimit: '音声ストリーム数の上限',
  connectionStatus: '通信状態',

  adSynclimits: 'ストリーム数の上限を同期',
  adLockAllContents: '一括ロック(コンテンツ)',
  adUnLockAllContents: '一括ロック解除(コンテンツ)',
  adMuteAllVideos: 'ミュート(ビデオ)',
  adShowAllVideos: 'ミュート解除(ビデオ)',
  adMuteAllMics: 'ミュート(マイク)',
  adSwitchOnAllMics: 'ミュート解除(マイク)',
  adRemoveAllContents: '削除(コンテンツ)',
  adClearContentsByUserName: 'コンテンツをユーザー名でクリア',
  adReload: '再読み込み',
  adBackColor: '背景色',
  adPatternColor:  'パターン色',
  adDefault: 'ディフォルト',
}
