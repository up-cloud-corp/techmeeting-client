...
export class LocalParticipant extends ParticipantBase implements Store<ILocalParticipant> {
  ...
  @observable callSoundStatus = 0  // Call notification sound playback status: 0 = Not playing, 1 = Waiting to play, 2 = Playing ver1.1
  // for lock mute button
  isMicMutingTime = Date.now()
  isMicMuting = false
  // for lock camera button
  isTurningOffCameraTime = Date.now()
  isTurningOffCamera = false
