            ...
            Row(t('ctNotAudioZone'), <Icon icon={imageLine} height={TITLE_HEIGHT}/>,
              ...
              <>
                { props.content.zone ? <IconButton size={'small'} onClick={()=>{
                  if (!props.content){ return }
                  if(props.content.zone === 'close')
                    props.content.zone = 'open'
                  else if(props.content.zone === 'open')
                    props.content.zone = 'same'
                  else if(props.content.zone === 'same')
                    props.content.zone = 'close'
                  props.updateOnly(props.content)}}>
                  <Icon icon={props.content.zone==='close' ? roomClosed : roomOpen} height={TITLE_HEIGHT}/>
                </IconButton> : undefined}
                {props.content.zone === 'close' ? t('ctClosedAudioZone') :
                  props.content.zone == 'same' ? t('ctSameAudioZone') : t('ctOpenAudioZone') }
              </>) : undefined }</Fragment>,
